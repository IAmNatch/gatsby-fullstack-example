  ...
  function(e, t) {
        ...
        if ('style' === t) {
          if (
            ((r && 'string' != typeof r && 'string' != typeof n) ||
              (e.style.cssText = r || ''),
            r && 'object' === (void 0 === r ? 'undefined' : k(r)))
          ) {
            if ('string' != typeof n)
    ...
    function D(e, t, n, r, o) {
      ...
      return (
        ...
        null == u.nextSibling
          ...
          : ((p && p.length) || null != u) &&
            j(i, p, n, r, R || null != M.dangerouslySetInnerHTML),
        z(i, t.attributes, M),
        (B = a),
        i
      );
    ...
    function j(e, t, n, r, o) {
      ...
      if (0 !== g)
        for (var z = 0; g > z; z++) {
          ...
          null != v
            ? (N++, (y[v] = b))
            : (w || (void 0 !== b.splitText ? !o || b.nodeValue.trim() : o)) &&
              (f[j++] = b);
        }
      if (0 !== T)
        for (var z = 0; T > z; z++) {
      ...
      if (N) for (var z in y) void 0 !== y[z] && h(y[z], !1);
    ...
    function w(e, t, n) {
      ...
      if (
        (e.prototype && e.prototype.render
          ...
          : ((r = new E(t, n)), (r.constructor = e), (r.render = v)),
        o)
      )
      ...
      if (!e._disable) {
        ...
        if (
          ...
          if ('function' == typeof I) {
            var E = M(i);
            (a = T),
              a && a.constructor === I && E.key == a.__key
                ? m(a, E, 1, l, !1)
                : ((b = a),
                  (e._component = a = w(I, E, l)),
            ...
            (s = j),
              (b = T),
              b && (s = e._component = null),
              (j || 1 === t) &&
                (s && (s._component = null),
                (v = g(s, i, l, n || !N, j && j.parentNode, !0)));
          if (j && v !== j && a !== T) {
            var L = j.parentNode;
            L &&
              v !== L &&
              (L.replaceChild(v, j), b || ((j._component = null), h(j, !1)));
          }
        ...
        if (
          (!N || n
            ? Y.unshift(e)
            : z ||
              (e.componentDidUpdate && e.componentDidUpdate(p, f, y),
    ...
    o(E.prototype, {
      setState: function(e, t) {
        var n = this.state;
        this.prevState || (this.prevState = o({}, n)),
    ...
    (function(e) {
      ...
      function M(e) {
        if (_n.spyListeners.length)
          for (var t = _n.spyListeners, n = 0, r = t.length; r > n; n++)
            t[n](e);
      }
      function l(e) {
        M(Ie({}, e, { spyReportStart: !0 }));
      }
      function p(e) {
        M(e ? Ie({}, e, Xt) : Xt);
      }
      function f(e) {
        return (
          _n.spyListeners.push(e),
          be(function() {
            var t = _n.spyListeners.indexOf(e);
            -1 !== t && _n.spyListeners.splice(t, 1);
          })
        );
      }
      function y() {
      ...
      function N(e) {
        Te(!0 !== e[Kt], 'Illegal state: cannot recycle array as iterator'),
          Le(e, Kt, !0);
        var t = -1;
        return (
          Le(e, 'next', function() {
      ...
      function m(e) {
        Te(null === _n.trackingDerivation, T('m028')),
          (_n.strictMode = e),
      ...
      function k(e, t, n, r, o, i) {
        Oe(e, '__mobxInitializedProps') || Ee(e, '__mobxInitializedProps', {}),
      ...
      function A(e) {
        !0 !== e.__mobxDidRunLazyInitializers &&
          ...
          (Ee(e, '__mobxDidRunLazyInitializers', !0),
      ...
      function C(e, t, n) {
        ...
        return (
          Te('function' == typeof o, T('m002')),
          Te(0 === o.length, T('m003')),
          Te(
      ...
      function R(e, t, n) {
        ...
        'string' == typeof e
          ? ((o = e), (i = t), (a = n))
          : ((o = e.name || 'Autorun@' + je()), (i = e), (a = t)),
          Te('function' == typeof i, T('m004')),
          Te(!1 === Q(i), T('m005')),
          a && (i = i.bind(a));
      ...
      function H(e, t, n, r) {
        ...
        'string' == typeof e
          ? ((i = e), (a = t), (s = n), (u = r))
          : ((i = e.name || 'AutorunAsync@' + je()), (a = e), (s = t), (u = n)),
          Te(!1 === Q(a), T('m006')),
          void 0 === s && (s = 1),
          u && (a = a.bind(u));
        var c = !1,
      ...
      function Z(e, t, n) {
        ...
        var o;
        (o = 'object' === (void 0 === n ? 'undefined' : Wt(n)) ? n : {}),
          (o.name = o.name || e.name || t.name || 'Reaction@' + je()),
      ...
      function V(e, t) {
        ...
        Te(Object.isExtensible(e), T('m035')),
          xe(e) ||
            (t = (e.constructor.name || 'ObservableObject') + '@' + je()),
          t || (t = 'ObservableObject@' + je());
        var n = new Dn(e, t);
        return Le(e, '$mobx', n), n;
      }
      function W(e, t, n, r) {
        if (e.values[t] && !gn(e.values[t]))
          return (
            Te(
              'value' in n,
              'The property ' +
      ...
      function J(e, t, n, o) {
        ...
        (n = (e.values[t] = new cn(n, o, e.name + '.' + t, !1)).value),
          Object.defineProperty(e.target, t, q(t)),
          ee(e, e.target, t, n);
      }
      function F(e, t, n, r, o, i) {
        i && Ae(e.target, t),
          (e.values[t] = new dn(n, e.target, o, e.name + '.' + t, r)),
      ...
      function ae(e, t, n) {
        Te(arguments.length >= 2, T('m014')),
          Te('object' === (void 0 === e ? 'undefined' : Wt(e)), T('m015')),
          Te(!Ln(e), T('m016')),
          n.forEach(function(e) {
            Te('object' === (void 0 === e ? 'undefined' : Wt(e)), T('m017')),
              Te(!ne(e), T('m018'));
          });
      ...
      function se(e) {
        ...
        if (
          (Te(1 >= arguments.length, T('m021')), Te(!ce(e), T('m020')), ne(e))
        )
          return e;
      ...
      function ce(e) {
        return (
          'object' === (void 0 === e ? 'undefined' : Wt(e)) &&
          null !== e &&
      ...
      function Me(e, t) {
        return (
          Te(!ce(t), 'Modifiers cannot be nested'),
      ...
      function ze(e) {
        return (
          -1 === An.indexOf(e) &&
          (An.push(e), console.error('[mobx] Deprecated: ' + e), !0)
        );
      }
      function be(e) {
        var t = !1;
      ...
      function xe(e) {
        if (null === e || 'object' !== (void 0 === e ? 'undefined' : Wt(e)))
          return !1;
      ...
      function Ue(e, t) {
        ...
        if (
          'object' === (void 0 === e ? 'undefined' : Wt(e)) &&
          'object' === (void 0 === t ? 'undefined' : Wt(t))
        ) {
          if (null === e || null === t) return !1;
          if (Ye(e) && Ye(t))
            return (
              e.size === t.size &&
              Ue(In.shallowMap(e).entries(), In.shallowMap(t).entries())
            );
      ...
      function Xe(e) {
        e.isPendingUnobservation ||
          ((e.isPendingUnobservation = !0), _n.pendingUnobservations.push(e));
      }
      function Ke() {
        _n.inBatch++;
      }
      ...
      function nt(e) {
        if (e.lowestObserverState !== Gn.STALE) {
          ...
          for (var t = e.observers, n = t.length; n--; ) {
            var r = t[n];
            r.dependenciesState === Gn.UP_TO_DATE && r.onBecomeStale(),
              (r.dependenciesState = Gn.STALE);
          }
        }
      }
      function rt(e) {
        if (e.lowestObserverState !== Gn.STALE) {
          ...
          for (var t = e.observers, n = t.length; n--; ) {
            var r = t[n];
            r.dependenciesState === Gn.POSSIBLY_STALE
              ? (r.dependenciesState = Gn.STALE)
              : r.dependenciesState === Gn.UP_TO_DATE &&
                (e.lowestObserverState = Gn.UP_TO_DATE);
          }
        }
      }
      function ot(e) {
        if (e.lowestObserverState === Gn.UP_TO_DATE) {
          ...
          for (var t = e.observers, n = t.length; n--; ) {
            var r = t[n];
            r.dependenciesState === Gn.UP_TO_DATE &&
              ((r.dependenciesState = Gn.POSSIBLY_STALE), r.onBecomeStale());
          }
        }
      }
      function it(e) {
      ...
      function at(e) {
        switch (e.dependenciesState) {
          ...
          case Gn.POSSIBLY_STALE:
            for (
              var t = ft(), n = e.observing, r = n.length, o = 0;
              r > o;
              o++
            ) {
              var i = n[o];
      ...
      function ut(e) {
        ...
        _n.computationDepth > 0 && t && he(T('m031') + e.name),
          !_n.allowStateChanges &&
            t &&
            he(T(_n.strictMode ? 'm030a' : 'm030b') + e.name);
      }
      function ct(e, t, n) {
        Nt(e),
      ...
      function Nt(e) {
        if (e.dependenciesState !== Gn.UP_TO_DATE) {
          ...
          for (var t = e.observing, n = t.length; n--; )
            t[n].lowestObserverState = Gn.UP_TO_DATE;
        }
      }
      function dt(e) {
        Te(this && this.$mobx && Jn(this.$mobx), 'Invalid `this`'),
          Te(
      ...
      function gt(e) {
        return (
          _n.globalReactionErrorHandlers.push(e),
          function() {
      ...
      function Tt(e) {
        return (
          ze('asReference is deprecated, use observable.ref instead'), In.ref(e)
        );
      }
      function zt(e) {
        return (
      ...
      function bt(e) {
        return (
          ze('asFlat is deprecated, use observable.shallow instead'),
          In.shallow(e)
        );
      }
      function wt(e) {
      ...
      function vt(e) {
        return L(
          function(t, n, r, o, i) {
            Te(void 0 !== i, T('m009')),
              Te('function' == typeof i.get, T('m010')),
              F(V(t, ''), n, i.get, i.set, e, !1);
          },
          function(e) {
            var t = this.$mobx.values[e];
            if (void 0 !== t) return t.get();
            ...
            : qt(e) || gn(e) || Jn(e)
              ...
              : Ln(e)
                ...
                : (A(e),
                  e.$mobx
                    ? e.$mobx
                    : void Te(!1, 'Cannot obtain administration from ' + e))
        );
      }
      function It(e, t) {
        var n;
        return (
          (n = void 0 !== t ? mt(e, t) : te(e) || Ln(e) ? xt(e) : mt(e)), n.name
        );
      }
      function Ot(e, t) {
        if (null === e || void 0 === e) return !1;
      ...
      function Ct(e, t) {
        return st() || console.warn(T('m013')), qn(e, { context: t }).get();
      }
      function Qt(e, t, n) {
        function r(r) {
      ...
      function Bt(e, t) {
        ...
        return (
          (e = mt(e)),
          gn(e) ? Pt(e.whyRun()) : Jn(e) ? Pt(e.whyRun()) : he(T('m025'))
        );
      }
      function Rt(e, t) {
        return Gt(mt(e, t));
      ...
      function Gt(e) {
        ...
        return (
          e.observing &&
            ...
            (t.dependencies = we(e.observing).map(Gt)),
          t
        );
      }
      function Ht(e, t) {
      ...
      function Vt(e, t, n) {
        ...
        return void 0 !== r.dehancer
          ? he('An intercept reader was already established')
        ...
        Ft = (function() {
          function e(e) {
            void 0 === e && (e = 'Atom@' + je()),
              ...
              (this.lowestObserverState = Gn.NOT_TRACKING);
          }
          return (
      ...
      var rn = (function() {
          function e(e, t, n, r) {
            (this.array = n),
              ...
              (this.atom = new Ft(e || 'ObservableArray@' + je())),
      ...
      var Nn = { identity: Y, structural: P, default: B },
        dn = (function() {
          function e(e, t, n, r, o) {
            (this.derivation = e),
              (this.scope = t),
              (this.equals = n),
              (this.dependenciesState = Gn.NOT_TRACKING),
              (this.observing = []),
              ...
              (this.runId = 0),
              (this.lastAccessedBy = 0),
              (this.lowestObserverState = Gn.UP_TO_DATE),
              (this.unboundDepsCount = 0),
              (this.__mapid = '#' + je()),
              (this.value = new Hn(null)),
              (this.isComputing = !1),
              (this.isRunningSetter = !1),
              (this.name = r || 'ComputedValue@' + je()),
              ...
              Te(
                ...
                0 === _n.inBatch
                  ? (Ke(),
                    ...
                    et())
                  : (tt(this), at(this) && this.trackAndCompute() && rt(this));
              var e = this.value;
      ...
      Object.keys(xn).forEach(function(e) {
        ...
        (In.deep.struct = In.struct),
        (In.ref.struct = function() {
          return 2 > arguments.length
            ? Me(Ne, arguments[0])
      ...
      var On = {},
        En = (function() {
          function e(e, t, n) {
            void 0 === t && (t = le),
              void 0 === n && (n = 'ObservableMap@' + je()),
              (this.enhancer = t),
              (this.name = n),
              (this.$mobx = On),
              (this._data = Object.create(null)),
              (this._hasMap = Object.create(null)),
              (this._keys = new on(void 0, fe, this.name + '.keys()', !0)),
              (this.interceptors = null),
              (this.changeListeners = null),
                  ...
                  xe(e)
                    ...
                    : Array.isArray(e)
                      ...
                      : Pe(e)
                        ...
                        : null !== e &&
                          void 0 !== e &&
                          he('Cannot initialize map from ' + e);
                }),
                this
              );
            }),
      ...
      var Hn = (function() {
        ...
        qn = function(e, t) {
          ...
          Te('function' == typeof e, T('m011')),
            Te(3 > arguments.length, T('m012'));
      ...
      'object' ===
        ('undefined' == typeof __MOBX_DEVTOOLS_GLOBAL_HOOK__
          ? 'undefined'
          : Wt(__MOBX_DEVTOOLS_GLOBAL_HOOK__)) &&
        __MOBX_DEVTOOLS_GLOBAL_HOOK__.injectMobx({ spy: f, extras: Xn }),
        (t.extras = Xn),
        (t.Reaction = Zn),
        (t.untracked = pt),
        (t.IDerivationState = Gn),
        (t.Atom = $t),
        (t.BaseAtom = Ft),
        (t.useStrict = m),
        ...
        (t.asStructure = zt),
        (t.asMap = wt),
        (t.isModifierDescriptor = ce),
        (t.isObservableObject = te),
        (t.isBoxedObservable = Mn),
        (t.isObservableArray = h),
        (t.ObservableMap = En),
        (t.isObservableMap = Ln),
        (t.map = ge),
        (t.transaction = de),
        (t.observable = In),
        (t.computed = qn),
        (t.isObservable = ne),
        (t.isComputed = Ot),
        (t.extendObservable = oe),
        (t.extendShallowObservable = ie),
        (t.observe = Et),
        (t.intercept = At),
        (t.autorun = R),
        (t.autorunAsync = H),
    ...
    function p(e) {
      if (
        ...
        return p(
          ...
          (t.displayName = (0, j.makeDisplayName)(e)),
          n)
        );
      }
  ...
  function(e, t, n) {
    ...
    function a(e, t, n) {
      var a,
        s,
        u = n ? '-with-' + n : '',
        c = (0, N.makeDisplayName)(t, { prefix: 'inject-', suffix: u }),
        p = ((s = a = (function(n) {
          function a() {
            return (
              r(this, a),
      ...
      Array.prototype.slice.call(o).forEach(function(e) {
        var t =
          null === e.getAttribute('data-netlify-identity-menu')
            ...
            : 'menu';
        (0,
        M.render)((0, M.h)(p.Provider, { store: D.default }, (0, M.h)(h.default, { mode: t, text: e.innerText.trim() })), e, null);
      }),
        D.default.init(a(t)),
        ...
        m && (O.setAttribute('style', m), (m = null));
    }
    Object.defineProperty(t, '__esModule', { value: !0 });
    var c = (function() {
        function e(e, t) {
                ...
                value: function() {
                  ...
                  if (e.settings)
                    return e.user
                      ...
                      : 'signup' === e.modal.page && e.settings.disable_signup
        ...
        a(t, [
          {
            ...
            value: function() {
              ...
              return (0, s.h)(
                ...
                t.map(function(e) {
                  return (0, s.h)(u, { key: e, provider: e, onLogin: n });
                })
              );
            },
          },
